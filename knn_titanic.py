...
train = pd.read_csv('D:py/datasets/titanic_train.csv')
test = pd.read_csv('D:py/datasets/titanic_test.csv')
...
final_prediction.to_csv('D:py/datasets/submissions/titanic_survival.csv', index=False)
